...
// The header on the university app's public pages (privacy, terms, contact,
// onboarding). The marketing site moved to shipithq.com/uni (plan/web/revamp
// REV-32); these pages only need a way home and a way in.
        ...
        <header className="sticky top-0 z-40 border-b border-neutral-200 bg-white/90 backdrop-blur-md dark:border-neutral-800 dark:bg-neutral-950/90">
            <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-page">
                <Link href="/signin" className="flex items-center gap-2.5">
                    ...
                    <span className="text-sm font-semibold tracking-tight text-neutral-900 dark:text-white">ShipItHQ for universities</span>
                </Link>
