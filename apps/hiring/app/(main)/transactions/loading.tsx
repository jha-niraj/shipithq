// Hand-matched to transactions/page.tsx: the page frame, PageHeader (no
// actions), the four-cell StatBand, search + status filter, then the
// transaction cards (icon, description, date, status badge, amount). Also the
// page's own client-side loading state.
                    ...
                    <div key={i} className="flex items-start justify-between gap-4 rounded-xl border border-neutral-200 bg-white p-5 dark:border-neutral-800 dark:bg-neutral-900">
                        <div className="flex items-start gap-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <Shimmer className="h-5 w-24 rounded-full" delay={i * 0.04} />
                            </div>
                        </div>
