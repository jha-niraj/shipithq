...
// The message and session shapes live in lib/ai/chat-types.ts so the server actions
// that fill this store can share them. Re-exported for existing imports.
import type {
	AIChatAction, AIChatAttachment, AIChatMessage, AIChatStep, AIChatSummary,
} from "@/lib/ai/chat-types";
import type { AssistantFeedback } from "@repo/db/assistant";
export type { AIChatAction, AIChatAttachment, AIChatMessage, AIChatStep, AIChatSummary };
