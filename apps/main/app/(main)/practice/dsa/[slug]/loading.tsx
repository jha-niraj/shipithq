...
// The workspace surface is a constant dark, so this skeleton is too.
    ...
    return (
        <div className="flex h-dvh w-full flex-col overflow-hidden bg-neutral-950">
            ...
            <div className="flex min-h-0 flex-1">
                <div className="w-1/4 min-w-0 space-y-4 border-r border-neutral-800 p-6">
                ...
                <div className="flex w-[40%] min-w-0 flex-col border-r border-neutral-800">
                    ...
                    <div className="h-[42%] shrink-0 border-t border-neutral-800">
                        <div className="flex h-10 items-center gap-2 border-b border-neutral-800 px-3">
                ...
                <div className="flex w-[35%] min-w-0 flex-col">
                    <div className="flex h-10 shrink-0 items-center border-b border-neutral-800 px-4">
                        <Shimmer className="h-3.5 w-16" />
                    </div>
                    <div className="shrink-0 space-y-2 border-b border-neutral-800 px-3 py-2.5">
