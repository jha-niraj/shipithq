...
export {
    toHref, flattenNavigation, computeDefaultPrimary, resolveSidebarPrimary,
    SIDEBAR_LOCKED_PATHS, SIDEBAR_PRIMARY_CAP,
    type LucideIcon, type NavigationItem, type FlatDestination, type SidebarPreset,
} from "@repo/ui/lib/shell-navigation"
import type { NavigationItem, SidebarPreset } from "@repo/ui/lib/shell-navigation"
