...
const grade = async (reply: string, q: string) => JSON.parse(((await openai.chat.completions.create({ model: modelFor("practiceCheckGrader"), temperature: 0, max_tokens: 150, response_format: { type: "json_object" }, messages: [
