...
// (see sidebar.tsx). Shared by apps/main and apps/hiring (plan/hiring-app HA-1):
// each app passes its own presets.
...
import {
    computeDefaultPrimary, SIDEBAR_PRIMARY_CAP, SIDEBAR_LOCKED_PATHS,
    type FlatDestination, type SidebarPreset,
...
export function CustomizeSidebarSheet({
    ...
    /** "Start from a preset" choices; the picker is hidden when there are none. */
